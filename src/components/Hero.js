...
const Hero = () => (
  ...
  >
    ...
    <div className="cta-buttons">
      <a href="https://drive.google.com/file/d/1vZj_lc41pzM0EAOjB5Hqqdu5jmz5Z91k/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn">View Resume</a> |
