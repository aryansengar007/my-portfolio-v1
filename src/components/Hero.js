...
const Hero = () => (
  ...
  >
    ...
    <div className="cta-buttons">
      <a href="https://drive.google.com/file/d/1X2BYcPlmSUZa4RIqfeWUIm2-UKfPNCUp/view?usp=sharing" target="_blank" rel="noopener noreferrer" className="btn">View Resume</a> |
